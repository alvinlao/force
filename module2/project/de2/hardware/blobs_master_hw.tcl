...
add_interface_port avalon_master pb1_master_addr address Output 32
add_interface_port avalon_master pb1_master_rd_en read Output 1
add_interface_port avalon_master pb1_master_wr_en write Output 1
add_interface_port avalon_master pb1_master_be byteenable Output 2
add_interface_port avalon_master pb1_master_readdata readdata Input 16
add_interface_port avalon_master pb1_master_writedata writedata Output 16
add_interface_port avalon_master pb1_master_waitrequest waitrequest Input 1
...
add_interface_port avalon_master_1 pb2_master_addr address Output 32
add_interface_port avalon_master_1 pb2_master_rd_en read Output 1
add_interface_port avalon_master_1 pb2_master_wr_en write Output 1
add_interface_port avalon_master_1 pb2_master_be byteenable Output 2
add_interface_port avalon_master_1 pb2_master_readdata readdata Input 16
add_interface_port avalon_master_1 pb2_master_writedata writedata Output 16
add_interface_port avalon_master_1 pb2_master_waitrequest waitrequest Input 1
