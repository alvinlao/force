...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL green
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file green.vhd VHDL PATH green.vhd TOP_LEVEL_FILE
...
add_parameter block_size INTEGER 1
set_parameter_property block_size DEFAULT_VALUE 1
...
add_parameter score_factor INTEGER 2
set_parameter_property score_factor DEFAULT_VALUE 2
set_parameter_property score_factor DISPLAY_NAME score_factor
set_parameter_property score_factor TYPE INTEGER
set_parameter_property score_factor UNITS None
set_parameter_property score_factor ALLOWED_RANGES -2147483648:2147483647
set_parameter_property score_factor HDL_PARAMETER true
add_parameter get_top_count INTEGER 5
set_parameter_property get_top_count DEFAULT_VALUE 5
set_parameter_property get_top_count DISPLAY_NAME get_top_count
set_parameter_property get_top_count TYPE INTEGER
set_parameter_property get_top_count UNITS None
set_parameter_property get_top_count HDL_PARAMETER true
