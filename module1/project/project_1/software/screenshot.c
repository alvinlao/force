...
// Read pixel buffer from memory and save as char*rgb
// Direct to SDcard
// Pass that array into bmp writer.
// BOOM
...
void SaveBmpSDCARD(){
	SavePixelArray();
	//write_bmp(const char *filename, FRAME_WIDTH, FRAME_HEIGHT, screenCapture);
...
void fwrite(data, numBytes, file){
